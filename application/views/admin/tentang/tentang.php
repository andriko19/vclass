              ...
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?= $no ?></td>
                      <td><img style="width: 300px" src="<?= base_url(); ?>asset/image/tentang/<?= $data['gambar']; ?>"></td>
                      <td><?= $data['nama_portal']; ?></td>
                      <td><?= $data['deskripsi']; ?></td>
                      <td><?= $data['link_youtube']; ?></td>
                      <!-- <td><?= date('d-m-Y', $data['creat_at']); ?></td> -->
                      <td>
                        <button type="button" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#UbahModal<?php echo $data['id_tentang'];?>">
                          <span class="icon text-white-50">
                            <i class="far fa-edit"></i>
                          </span>
                        </button> ||
                        <a href="" onclick="$('#modalHapus #formDelete').attr('action','<?= base_url() ;?>admin/hapus_tentang/<?= $data['id_tentang']; ?>')" class="btn btn-danger btn-icon-split" data-toggle="modal" data-target="#modalHapus"> 
                          <span class="icon text-white-50">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo form_open_multipart('admin/proses_tambah_tentang');?>
          <div class="form-group">
            <label>Nama Portal</label>
            <input type="text" name="nama_portal" class="form-control" required="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <small class="text-danger"> Disarankan Ukuran Gambar : 1024px X 1016px.</small>
          </div>
        </div>
  ...
  <!-- modal ubah -->
  <?php $no = 0;
    foreach ($tentang as $data) : $no++; ?>
    <div class="modal fade" id="UbahModal<?php echo $data['id_tentang'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <?php echo form_open_multipart('admin/proses_ubah_tentang');?>
            <input type="hidden" name="id_tentang" value="<?= $data['id_tentang'];?>">
            <div class="form-group">
              <label>Nama Portal</label>
              <input type="text" name="nama_portal" class="form-control" value="<?= $data['nama_portal'];?>" required="">
            </div>
            <div class="form-group">
              <label>Deskripsi</label>
            ...
            <div class="form-group">
              <label>Link Youtube</label>
              <input type="text" name="link_youtube" class="form-control" value="<?= $data['link_youtube'];?>" required="">
            </div>
            <div class="form-group">
              <label>Gambar</label>
              <div class="row">
                <div class="col-sm-4">
                  <img src="<?= base_url(); ?>asset/image/tentang/<?= $data['gambar']; ?>" class="img-thumbnail">
                </div>
                <div class="col-sm-8">
