              ...
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?= $no ?></td>
                      <td><?= $data['nama_panduan']; ?></td>
                      <td><?= $data['file']; ?></td>
                      <td><?= date('d-m-Y', $data['creat_at']); ?></td>
                      <td>
                        <button type="button" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#UbahModal<?php echo $data['id_panduan'];?>">
                          <span class="icon text-white-50">
                            <i class="far fa-edit"></i>
                          </span>
                        </button> ||
                        <a href="" onclick="$('#modalHapus #formDelete').attr('action','<?= base_url() ;?>admin/hapus_panduan/<?= $data['id_panduan']; ?>')" class="btn btn-danger btn-icon-split" data-toggle="modal" data-target="#modalHapus"> 
                          <span class="icon text-white-50">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo form_open_multipart('admin/proses_tambah_panduan');?>
          ...
          <div class="form-group">
            ...
            <small class="text-danger"> Disarankan ukuran file max 4MB.</small>
          </div>
        </div>
  ...
  <!-- modal ubah -->
  <?php $no = 0;
    foreach ($panduan as $data) : $no++; ?>
    <div class="modal fade" id="UbahModal<?php echo $data['id_panduan'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <?php echo form_open_multipart('admin/proses_ubah_panduan');?>
            <input type="hidden" name="id_panduan" value="<?= $data['id_panduan'];?>">
            <div class="form-group">
              <label>Nama Panduan</label>
              <input type="text" name="nama_panduan" class="form-control" value="<?= $data['nama_panduan'];?>" required="">
            </div>
            <div class="form-group">
